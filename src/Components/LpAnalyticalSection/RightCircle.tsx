...
const RightCircle: React.FC = () => {
  return (
    <div className=" flex size-max justify-center ">
      <div
        className="right-circle  top-10  m-[4px] right-0  bg-[#FFFFFF33]
 ...
 justify-center items-center transition-transform duration-300 ease-out"
      ...
      <div className="right-circle  top-10  m-[4px] right-0 w-40 h-40 bg-[#FFFFFF33] bg-opacity-70 rounded-full text-center text-white flex flex-col justify-center items-center transition-transform duration-300 ease-out">
