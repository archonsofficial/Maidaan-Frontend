...
export default function HeroSection() {
  return (
    <>
     ...
     <img src={img1} 
     className="h-[500px] z-20 absolute left-2" 
     alt="Sports" 
     />
    ...
    <img src={img2} 
     ...
     <img src={img3} 
     className="h-[460px] z-20 absolute right-5" 
     alt="Sports" 
     />
     ...
     <div className="truncate z-10 h-12 w-full bg-[#CEF23F] flex  items-center mt-40 origin-bottom-left -rotate-1">
        ...
        <p className=" text-black  font-medium text-4xl  ml-40 animate-slideInOutSecond">
          The Best Platform for Sports and Fitness
        </p>
